let colorCh = document.querySelector('#color')
let colw = document.querySelector('#colw')
    ...
    for (j = 0; j < 64; j++)
        {
            ...
            if(chC == 0){
                 arr[b][a].style.backgroundColor =  white()
                 chC = 1
                 
            }else {
                arr[b][a].style.backgroundColor = black()
                chC = 0
            }
                if(a<7){
                    a++
...
break
 ...
 y1=e.target.id[1]*1
 x1=xarr.indexOf(e.target.id[0])*1+1
 if(e.target.id[3] == 'w'){if(y1 == 2) {if(arr[8-y1-2][x1-1].id[3] == undefined & arr[8-y1-1][x1-1].id[2] == undefined) {hClv.push(arr[8-y1-2][x1-1].id)}}
if(x1 != 1) {if(arr[8-y1*1-1][x1*1-2].id[3] == 'b') {hClv.push(arr[8-y1*1-1][x1*1-2].id)}}
 ...
 if(e.target.id[3] == 'b'){if(y1 == 7 ){ if(arr[8-y1+2][x1-1].id[3] == undefined & arr[8-y1+1][x1-1].id[2] == undefined) {hClv.push(arr[8-y1+2][x1-1].id)}}
...
if(x2 != -1 & y2 != -1 )
   ...
   if(hClv.length != 0) {arr[8 - e.target.id[1]][xarr.indexOf(e.target.id[0])].style.outline = '0.5vw solid green'
   }else{arr[8 - e.target.id[1]][xarr.indexOf(e.target.id[0])].style.outline = '0.5vw solid red'}
    y2 = 8-e.target.id[1]
